    ...
    try {
      ...
      const colleges = [
        ...
        },
        {
         ...
         {
    name: "Central University Europe",
    location: "Budapest, Hungary",
    region: "Abroad",
    description: "International university offering multidisciplinary programs across Arts, Sciences, Business, and Technology.",
    image: "",
    coursesOffered: [
      await getCourseId("B.Tech"),
      await getCourseId("MBA"),
      await getCourseId("LLM in Human Rights"),
      await getCourseId("Economics, Data and Policy MA / M.Sc"),
      await getCourseId("PhD"),
    ],
  },
      ];
